...
class Trainer:
    ...
    def before_train_step(self):
        ...
        generator_total = self.dataset['train'].sampling_generator_energy(num_samples=self.cfg.num_data_sample,
                                                                        batch_size=self.cfg.batch_size)
    ...
    def run_train_step(self):
        for traj_np in self.generator_train:
                ...
                t = self.diffusion.sample_timesteps(traj.shape[0]).to(self.cfg.device)#1至1k，取64个
